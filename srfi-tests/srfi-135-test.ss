...
(define (as-text . args)
  (textual-concatenate (map (lambda (x)
                              (cond ((text? x) x)
                                    ...
                                    ((char? x) (text x))
                                    (else
                                      (error 'as-text "as-text: illegal argument" x))))
                            args)))
...
(test-assert (equal? '#vu8(97 98 99)
                     (textual->utf8 (as-text "abc"))))

(test-assert (equal? '#vu8(97 98 99)
                     (textual->utf8 "abc")))

(test-assert (equal? '#vu8(97 98 99 121 121 121 122 122 122)
...
(test-assert (equal? '#vu8(254 255 0 97 0 98 0 99)
                     (textual->utf16 (as-text "abc"))))

(test-assert (equal? '#vu8(254 255 0 97 0 98 0 99)
                     (textual->utf16 "abc")))

(test-assert (equal? '#vu8(254 255 0 97 0 98 0 99 0 121 0 121 0 121 0 122 0 122 0 122)
...
(test-assert (equal? '#vu8(0 97 0 98 0 99)
                     (textual->utf16be (as-text "abc"))))

(test-assert (equal? '#vu8(0 97 0 98 0 99)
                     (textual->utf16be "abc")))

(test-assert (equal? '#vu8(0 97 0 98 0 99 0 121 0 121 0 121 0 122 0 122 0 122)
...
(test-assert (equal? '#vu8(97 0 98 0 99 0)
                     (textual->utf16le (as-text "abc"))))

(test-assert (equal? '#vu8(97 0 98 0 99 0)
                     (textual->utf16le "abc")))

(test-assert (equal? '#vu8(97 0 98 0 99 0 121 0 121 0 121 0 122 0 122 0 122 0)
...
(test-assert (result=? "abc"
                       (utf8->text '#vu8(97 98 99))))

(test-assert (result=? "abcyyyzzz"
                       (utf8->text '#vu8(0 1 2 97 98 99 121 121 121 122 122 122) 3)))
...
(test-assert (result=? "abc"
                       (utf16be->text '#vu8(0 97 0 98 0 99))))
...
(test-assert (result=? "abc"
                       (utf16le->text '#vu8(97 0 98 0 99 0))))
...
(let ((bv (textual->utf16 beyondBMP)))
  (test-assert (equal? bv
                       '#vu8(254 255 0 97 0 192 3 191
                             216 53 220 65 216 52 221 19 216 52 221 16 0 122)))
  (equal? bv
          '#vu8(255 254 97 0 192 0 191 3
                53 216 65 220 52 216 19 221 52 216 16 221 122 0))

  (test-assert (equal?
                 '#vu8(0 97 0 192 3 191 216 53 220 65 216 52 221 19 216 52 221 16 0 122)
                 (textual->utf16be beyondBMP)))

  (test-assert (equal?
                 '#vu8(97 0 192 0 191 3 53 216 65 220 52 216 19 221 52 216 16 221 122 0)
...
(test-assert (result=? "abc" (textual-map string (string->text "abc"))))
