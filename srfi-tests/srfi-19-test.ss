...
(test-begin "srfi-19-time")

(test-assert "Creating time structures"
...
(test-assert "Testing time resolutions"
...
(test-assert "Time comparisons (time=?, etc.)"
