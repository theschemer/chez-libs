...
(test-group "bitwise"
            ...
            (test-equal "test-137" 0 (integer-length 0))
            (test-equal "test-138" 8 (integer-length 128))
            (test-equal "test-139" 8 (integer-length 255))
            (test-equal "test-140" 9 (integer-length 256))
