(import (rnrs)
        ...
        (srfi :113 sets)
        (except (srfi :64 testing) test-equal))
...
(test-group "sets"
            ...
            (test-group "sets/whole"
                        ...
                        (let ((hetero (set eqv-comparator 1 2 'a 3 4))
                          ...
                          (test-equal 'a (set-find symbol? hetero (lambda () (error 'sets/whole "wrong"))))
                          (test-error  (set-find symbol? homo (lambda () (error 'sets/whole "wrong"))))
...
(test-group "bags"
            ...
            (test-group "bags/whole"
                        ...
                        (let ((hetero (bag eqv-comparator 1 2 'a 3 4))
                          ...
                          (test-equal 'a (bag-find symbol? hetero (lambda () (error 'bags/whole "wrong"))))
                          (test-error  (bag-find symbol? homo (lambda () (error 'bags/whole "wrong"))))
